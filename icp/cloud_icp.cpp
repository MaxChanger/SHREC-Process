...
int main(int argc, char **argv)
{
	...
	// A translation on x y z axis (0.4 meters)
	// transformation_matrix(0, 3) = -0.33;
	// transformation_matrix(1, 3) = -0.35;
	// transformation_matrix(2, 3) = -0.12;
	...
	pcl::transformPointCloud(*cloud_B, *cloud_icp, transformation_matrix);
